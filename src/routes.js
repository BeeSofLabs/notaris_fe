...
import App from './app';
import { asyncHome, asyncUserInfo, LoadingAssign, Assign, NotFound, List, Detail, Order, Login, Register, Account, Forgot, Payment, PaymentDetail, History, Dashboard, DashboardListOrder, AddAgunan } from './pages';
